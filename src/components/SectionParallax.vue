...
onMounted(() => {
  gsap.fromTo(
    ".sectionParallax__wrapper__boxTitle__sticky__wrapper__subtitle span",
    {
      yPercent: 150,
    },
    {
  ...
  const itemsPosition = document.querySelectorAll(
    ".sectionParallax__wrapper__boxContent__colonne__background",
  );
  ...
  const videoHeight = document.querySelectorAll(
    ".sectionParallax__wrapper__boxContent__colonne__background__videoWrapper",
  );
  const imageHeight = document.querySelectorAll(
    ".sectionParallax__wrapper__boxContent__colonne__background__imgWrapper",
  );
    ...
    <div class="sectionParallax__wrapper">
      <div class="sectionParallax__wrapper__boxContent">
        <div class="sectionParallax__wrapper__boxContent__colonne">
          <div
            class="sectionParallax__wrapper__boxContent__colonne__background"
          >
            <div
              class="sectionParallax__wrapper__boxContent__colonne__background__videoWrapper"
            >
        ...
        <div class="sectionParallax__wrapper__boxContent__colonne">
          ...
          >
            ...
            >
              <video autoplay muted loop>
                <source src="/parallax/parallax3.mp4" data-wf-ignore="true" />
              </video>
            </div>
          </div>
        </div>
        ...
        <div class="sectionParallax__wrapper__boxContent__colonne">
          ...
          >
            <img
              src="/parallax/parallax4.webp"
              loading="lazy"
              alt="parallax image 4"
              class="sectionParallax__wrapper__boxContent__colonne__background__imgWrapper"
            />
          </div>
        </div>
        <div class="sectionParallax__wrapper__boxContent__line"></div>
          ...
          >
            ...
            >
              <video autoplay muted loop data-object-fit="cover">
                <source src="/parallax/parallax6.mp4" data-wf-ignore="true" />
              </video>
            </div>
          </div>
        </div>
      ...
      <div class="sectionParallax__wrapper__boxTitle">
        <div class="sectionParallax__wrapper__boxTitle__sticky">
          <div class="sectionParallax__wrapper__boxTitle__sticky__wrapper">
            <div
              class="sectionParallax__wrapper__boxTitle__sticky__wrapper__subtitle is-clickable"
            >
              <span>Get Started</span>
            </div>
            <div
              class="sectionParallax__wrapper__boxTitle__sticky__wrapper__title is-clickable"
            >
