...
const newsItems = [
  ...
  [
    "/news/news3.webp",
    "Missed Birthdays wins Gold at Cannes Lions 2025!",
  ...
  [
    "/news/news6.webp",
    "Creative catch-ups: Iva Troj PhD",
  ...
  [
    "/news/news7.webp",
    "Creative catch-ups: Sophie Oliveira Barata",
    ...
    <div class="sectionNews__header">
      ...
      <div class="sectionNews__header__boxTitle">
        ...
        <div class="sectionNews__header__boxTitle__slider">
          <div
            class="sectionNews__header__boxTitle__slider__prev is-clickable"
            ref="prevBtn"
          >
          ...
          <div
            class="sectionNews__header__boxTitle__slider__next is-clickable"
            ref="nextBtn"
          >
