      ...
      <div class="pin-wrapper" ref="pinEl">
        <div class="sectionHero__subtitle__textWrapper">
          <div class="sectionHero__subtitle__textWrapper__text">
            <p class="sectionHero__subtitle__textWrapper__text__top">
              Brighton, United Kingdom
            </p>
            <p class="sectionHero__subtitle__textWrapper__text__bottom">
              Production, design, and the art of the possible.
            </p>
          </div>
        </div>
      </div>
