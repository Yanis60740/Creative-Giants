...
const testimonialsItems = [
  ...
  [
    "Not content with executing whatever you ask of them to the highest standard, they consistently improve and develop concepts, taking them in exciting new directions I could have never foreseen.",
    "John Wildes",
    "Edelman",
  ],
  [
    "I’ve worked with Creative Giants for many years, and they never fail to deliver… they jump head feet into all challenges and over-deliver every time. What I especially like about them is that they often enhance the creative, as well as being solutions orientated…",
    "Emilie Verlander",
    "Edelman",
  ],
];
...
const next = () => {
  ...
  const boxWidth = testimonialsContainerRef.value.querySelector(
...
const carousselItems = [
  "/caroussel/caroussel1.svg",
  "/caroussel/caroussel2.png",
  "/caroussel/caroussel3.svg",
  "/caroussel/caroussel4.svg",
  "/caroussel/caroussel5.svg",
  "/caroussel/caroussel6.svg",
  "/caroussel/caroussel7.svg",
  "/caroussel/caroussel8.svg",
  "/caroussel/caroussel9.svg",
];
  ...
  <section class="sectionTestimonials">
    <div class="sectionTestimonials__header">
      ...
      <div class="sectionTestimonials__header__slider">
        <div
          class="sectionTestimonials__header__slider__prev is-clickable"
          ref="prevBtn"
        >
        ...
        <div
          class="sectionTestimonials__header__slider__next is-clickable"
          ref="nextBtn"
        >
    ...
    <div class="sectionTestimonials__caroussel">
      <div class="sectionTestimonials__caroussel__box" aria-hidden="true">
        <div
          v-for="(item, index) in carousselItems"
          :key="index"
          class="sectionTestimonials__caroussel__box__item"
        >
          <img :src="item" />
        </div>
      </div>
