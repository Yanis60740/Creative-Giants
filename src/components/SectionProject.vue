...
onMounted(() => {
  ...
  const itemWidthDeduction =
    images[images.length - 1].offsetWidth -
    images[images.length - 1].offsetWidth / 2.5;
  ...
  tl.fromTo(image1, { xPercent: -27 }, { xPercent: -40, ease: "power1.out" });
    ...
    <div class="sectionProject__container">
      <div class="sectionProject__container__itemWrapper">
        ...
        >
          <div class="sectionProject__container__itemWrapper__item__leftBox">
            <div
              class="sectionProject__container__itemWrapper__item__leftBox__label"
            >
              <p
                class="sectionProject__container__itemWrapper__item__leftBox__label__text"
              >
                {{ item[0] }}
              </p>
            </div>
            <div
              class="sectionProject__container__itemWrapper__item__leftBox__title"
            >
              <p
                class="sectionProject__container__itemWrapper__item__leftBox__title__text"
              >
                {{ item[1] }}
              </p>
            </div>
          ...
          <div class="sectionProject__container__itemWrapper__item__rightBox">
            <div
              class="sectionProject__container__itemWrapper__item__rightBox__wrapper"
            >
              <div
                class="sectionProject__container__itemWrapper__item__rightBox__wrapper__img is-clickable"
              >
                <div
                  class="sectionProject__container__itemWrapper__item__rightBox__wrapper__img__image-wrapper"
                >
                  <img
                    loading="lazy"
                    :src="item[2]"
              ...
              <div
                class="sectionProject__container__itemWrapper__item__rightBox__wrapper__info"
              >
                <div
      ...
      <div class="sectionProject__container__progressWrapper">
        <div class="sectionProject__container__progressWrapper__progressBar">
          <div
            class="sectionProject__container__progressWrapper__progressBar__fill"
          ></div>
        </div>
        <div class="sectionProject__container__progressWrapper__progressText">
          <p></p>
          <div
            class="sectionProject__container__progressWrapper__progressText__viewAll is-clickable"
          >
